...
const string DFLT_SERVER_ADDRESS	{ "tcp://localhost:1888" };
const string CLIENT_ID				{ "mocker" };
...
int main(int argc, char* argv[])
{
	...
	try {
		...
		cout << "Waiting for the connection..." << conntok << endl;
		conntok->wait();
		cout << "  ...OK" << endl;

        cout << "\n***\nServer reading: " << client.is_connected() << " " << client.get_server_uri() << endl; // hmmm
